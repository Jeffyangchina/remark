...
def add_layer(input,insize,outsize,layer_name=None,activation_function=None,keep_prob=1):
    ...
    return outputs
#add output layer
l1=add_layer(xs,in_size,512,'l1',activation_function=tf.nn.relu)
l2=add_layer(l1,512,256,'l2',activation_function=tf.nn.relu)
prediction=add_layer(l2,256,out_size,'l3',activation_function=tf.nn.relu)
...
with sess.as_default():
    ...
    save_path=saver.save(sess,'yang/tensor1.ckpt')
    print(save_path)
