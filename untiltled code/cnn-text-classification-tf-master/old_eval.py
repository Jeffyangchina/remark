...
tf.flags.DEFINE_string("checkpoint_dir", "./runs/1526209087/checkpoints/model-79200.data-00000-of-00001", "Checkpoint directory from training run")
...
y_test = np.argmax(y_test, axis=1)
parent_path = os.path.dirname(FLAGS.checkpoint_dir)
parent = os.path.dirname(parent_path)
vocab_path = os.path.join(parent, "vocab")
